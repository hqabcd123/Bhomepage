...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\c_ip\Desktop\python\btech_search_engine\venv_btech_homepage'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\c_ip\Desktop\python\btech_search_engine\venv_btech_homepage\Scripts\deactivate.nu'
